...
* When you have completed the assignment, you need to  push your code to this repository and [mark the assignment as completed by clicking here](https://app.snapcode.review/submission_links/e19f86e5-39ad-4980-b58a-6792c6a97267).
...
A simple HTTP API that returns publicly available Gists for a given GitHub user.
...
**Pagination (optional):**
```
http://localhost:8080/octocat?page=1&per_page=10
```
...
- GitHub unauthenticated rate limit is 60 requests/hour